...
# ===================================================
  ...
  print("Ejecutando algoritmo de Búsqueda Harmónica\n")
  from hs import *
# ---------------------------------------------
elif args.a == "hs-ls":
  print("Ejecutando algoritmo de Búsqueda Harmónica con LS\n")
  from hs_ls import *
# ---------------------------------------------
elif args.a == "hs-ls-v2":
  print("Ejecutando algoritmo de HS-LS con parámetros adaptativos\n")
  from hs_ls_v2 import *
# ===================================================
else:

...
int rotar_objeto = 0, rotar_foco = 0;

bool cambiar_luz = false,
     luz_activa = true;
...
void draw_objects() {
  switch (t_objeto){
    ...
    case ATAT: atat.draw(modo,0.5,0.5,0.5,0.6,0.6,0.6,2);break;
  }
}
...
void iluminacion(float rotacion) {
  GLfloat light0_intensity[4]  = {0.5,0.5,0.5,1},
          light0_ambient[4]    = {0.0,0.0,0.0,1},
          light0_position[4]   = {0,1,0,0};

  GLfloat light1_intensity[4]  = {0.9,0.9,0.9,1},
          light1_ambient[4]    = {1.0,0.0,1.0,1},
          light1_position[4]   = {20,10,0,1};

  if (cambiar_luz) {
    light1_ambient[0] = 1.0;
    light1_ambient[1] = 0.3;
  ...
  switch (toupper(Tecla1)){
    ...
    case '6':modo=SOLID_ILLUMINATED_GOURAUD;break;
          ...
          case 'T':t_objeto=ATAT;           break;
            case 'I':rotar_foco++;          break;
            case 'U':cambiar_luz=!cambiar_luz;break;
            case 'Y':        
              cubo.cambiar_material();
              piramide.cambiar_material();
              ply.cambiar_material();
              rotacion.cambiar_material();
              tanque.cambiar_material();
              atat.cambiar_material();
              break;
            case 'J': luz_activa=true; break;
            case 'K': luz_activa=false; break;
  }
...
void animacion() {
  if (rotar_objeto > 0) {
    ...
    draw();
    rotar_objeto = (rotar_objeto < 80)? rotar_objeto+1 : 1;
  }
}

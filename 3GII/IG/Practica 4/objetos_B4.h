...
class _triangulos3D: public _puntos3D {
       public:
              ...
              void 	draw_iluminacion_plana();  // Podría recibir 7 parámetros (float ambiente_difuso_rojo, ..., float especular_rojo, ..., float brillo)
              ...
              vector<_vertex4f> ambiente_difusa;     //coeficientes ambiente y difuso
              vector<_vertex4f> especular;           //coeficiente especular
              vector<float> brillo;                  //exponente del brillo 

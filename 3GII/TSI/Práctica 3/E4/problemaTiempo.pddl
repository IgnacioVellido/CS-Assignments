; Varios aviones con poco tiempo de vuelo
...
(:init
    ...
    (= (capacity a4) 5000)
    (= (refuel-rate a4) 20)
    (= (max-tiempo-vuelo a4) 50)
    (= (num-pasajeros a4) 0)
    (= (max-pasajeros a4) 100)
...
(:tasks-goal
   :tasks(
    (transport-person p10 malaga)  
    (transport-person p9 sevilla)    
    (transport-person p8 huelva)    
    (transport-person p7 huelva)    

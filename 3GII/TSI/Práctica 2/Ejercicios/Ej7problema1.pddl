...
;;; Ejercicio 7 Problema 1
;;; Definición del problema
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; 25 zonas y 5 personajes, obtiene al menos 15 puntos, 3 el primero y 7 el
;;; segundo
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; Mapa
;;; 01  02  03  04  05
...
(define (problem EJERCICIO-7-Apartado_b) (:domain EJERCICIO-7)
  (:objects 
    repartidor_1 - repartidor
    repartidor_2 - repartidor
    recogedor_1 - recogedor
    recogedor_2 - recogedor
    ...
    bikini_1 bikini_2 - bikini
    zapatilla_1 zapatilla_2 - zapatilla        
  ...
  (:init
      (posicion_jugador repartidor_1 zona_1)
      (orientacion repartidor_1 n)

      (posicion_jugador repartidor_2 zona_1)
      (orientacion repartidor_2 s)

      (posicion_jugador recogedor_1 zona_1)
      (orientacion recogedor_1 s)

      (posicion_jugador recogedor_2 zona_1)
      (orientacion recogedor_2 s)

      ; Objetos --------
      (posicion_objeto oscar_1 zona_23)
      (posicion_objeto rosa_1 zona_15)
      (posicion_objeto oro_1 zona_2)
      (posicion_objeto oro_2 zona_2)
      ...
      (posicion_objeto bikini_2 zona_1)
      (posicion_objeto zapatilla_2 zona_3)
      ...
      (= (coste-camino zona_7 zona_2) 5)
      (= (coste-camino zona_7 zona_12) 3)
      (= (coste-camino zona_12 zona_7) 5)
      (= (coste-camino zona_12 zona_17) 3)
      (= (coste-camino zona_17 zona_12) 5)
      (= (coste-camino zona_17 zona_22) 3)
      (= (coste-camino zona_22 zona_17) 5)

      (= (coste-camino zona_3 zona_8) 3)
      (= (coste-camino zona_8 zona_3) 5)
      (= (coste-camino zona_8 zona_13) 3)
      (= (coste-camino zona_13 zona_8) 5)
      (= (coste-camino zona_13 zona_18) 3)
      (= (coste-camino zona_18 zona_13) 5)
      (= (coste-camino zona_18 zona_23) 3)
      (= (coste-camino zona_23 zona_18) 5)

      (= (coste-camino zona_4 zona_9) 3)
      (= (coste-camino zona_9 zona_4) 10)
      (= (coste-camino zona_9 zona_14) 3)
      (= (coste-camino zona_14 zona_9) 10)
      (= (coste-camino zona_14 zona_19) 3)
      (= (coste-camino zona_19 zona_14) 10)
      (= (coste-camino zona_19 zona_24) 3)
      (= (coste-camino zona_24 zona_19) 10)

      (= (coste-camino zona_5 zona_10) 3)
      (= (coste-camino zona_10 zona_5) 10)
      (= (coste-camino zona_10 zona_15) 3)
      (= (coste-camino zona_15 zona_10) 10)
      (= (coste-camino zona_15 zona_20) 3)
      (= (coste-camino zona_20 zona_15) 10)
      (= (coste-camino zona_20 zona_25) 3)
      (= (coste-camino zona_25 zona_20) 10)
      ...
      ; Puntos -------------  
      (= (puntos-totales) 0)
      (= (puntos-jugador repartidor_1) 0)
      (= (puntos-jugador repartidor_2) 0)
      ...
      (= (conseguir-puntos oro_2 leonardo_1) 5)
      (= (conseguir-puntos oro_2 princesa_1) 4)
      (= (conseguir-puntos oro_2 bruja_1) 3)
      (= (conseguir-puntos oro_2 profesor_1) 1)
      (= (conseguir-puntos oro_2 principe_1) 10)  

      (= (conseguir-puntos zapatilla_1 leonardo_1) 0)
      (= (conseguir-puntos zapatilla_1 princesa_1) 0)
      (= (conseguir-puntos zapatilla_1 bruja_1) 0)
      (= (conseguir-puntos zapatilla_1 profesor_1) 0)
      (= (conseguir-puntos zapatilla_1 principe_1) 0)  

      (= (conseguir-puntos zapatilla_2 leonardo_1) 0)
      (= (conseguir-puntos zapatilla_2 princesa_1) 0)
      (= (conseguir-puntos zapatilla_2 bruja_1) 0)
      (= (conseguir-puntos zapatilla_2 profesor_1) 0)
      (= (conseguir-puntos zapatilla_2 principe_1) 0)  

      (= (conseguir-puntos bikini_1 leonardo_1) 0)
      (= (conseguir-puntos bikini_1 princesa_1) 0)
      (= (conseguir-puntos bikini_1 bruja_1) 0)
      (= (conseguir-puntos bikini_1 profesor_1) 0)
      (= (conseguir-puntos bikini_1 principe_1) 0)  
      
      (= (conseguir-puntos bikini_2 leonardo_1) 0)
      (= (conseguir-puntos bikini_2 princesa_1) 0)
      (= (conseguir-puntos bikini_2 bruja_1) 0)
      (= (conseguir-puntos bikini_2 profesor_1) 0)
      (= (conseguir-puntos bikini_2 principe_1) 0)  

      ; Bolsillos -------------  
      (= (bolsillo-actual bruja_1) 0)
      (= (bolsillo-actual profesor_1) 0)
      (= (bolsillo-actual princesa_1) 0)
      (= (bolsillo-actual principe_1) 0)
      (= (bolsillo-actual leonardo_1) 0)

      (= (bolsillo-maximo bruja_1) 2)
      (= (bolsillo-maximo profesor_1) 2)
      (= (bolsillo-maximo princesa_1) 5)
      (= (bolsillo-maximo principe_1) 3)
      (= (bolsillo-maximo leonardo_1) 2)
  )

  (:goal (and 
              (>= (puntos-totales) 15)  
              (>= (puntos-jugador repartidor_1) 3)
              (>= (puntos-jugador repartidor_2) 7)
         )
  )

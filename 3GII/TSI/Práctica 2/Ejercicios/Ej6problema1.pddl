...
(define (problem EJERCICIO-6-Apartado_b) (:domain EJERCICIO-6)
  (:objects 
    jugador_1 - jugador
    jugador_2 - jugador
  ...
  (:init
      ...
      (posicion_jugador jugador_2 zona_1)
      (orientacion jugador_2 s)
      ...
      ; Puntos -------------  
      (= (puntos-totales) 0)
      (= (puntos-jugador jugador_1) 0)
      (= (puntos-jugador jugador_2) 0)
  ...
  (:goal (and (>= (puntos-totales) 7)  
              (>= (puntos-jugador jugador_1) 3)
              (>= (puntos-jugador jugador_2) 4)
         )
  )
